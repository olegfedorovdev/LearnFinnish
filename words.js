...
var words = {
    ...
    "latest" : {
        ...
        "words" : [
            ...
            {"fi":"koko ajan", "en":"all the time", "ru": "все время"},
            {"fi":"selvä juttu", "en":"all clear", "ru": "все понятно"},
